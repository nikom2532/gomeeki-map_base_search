	...
	*/
	...
	$this->config = array_merge(
      array(
        ...
        // change the values below to ones for your application
        'consumer_key'    => 'YdljHfELFcHxaF0eyazk2SfMY',
        'consumer_secret' => '08ugbkfVGT7dF7SG6yvKSMgL0niOtsrYM0W1aEJM2v2AkF3z3N',
        'token'           => '109898812-CF7g8GFIszC4sUTEhdorPgCtRzYee7TUNWCTDiCt',
        'secret'          => '6v8y9cLvgflg0W3VBpmrWqELHpRQCF1P47LfQB8kJ990W',
        'bearer'          => 'YOUR_OAUTH2_TOKEN',

        'user_agent'      => 'nikom2532 ' . parent::VERSION . ' Examples 0.1',
      ),
      $config
    );
